...
public class GeneralTableModelDemo extends AbstractTableModel {
	...
	public GeneralTableModelDemo(Vector<Vector<Object>> data, String[] columnNames, int totalColumnCount, boolean editable){
		this.data = data; 
...
//				return false;
	...
	public static void main(String[] args) {
		...
		GeneralTableModelDemo tableModel = new GeneralTableModelDemo(data, columnNames,
				7, true);
