...
public class GeneralTablePanelDemo extends JPanel implements ActionListener,
	...
	protected GeneralTableModelDemo tableModel;
	...
	public GeneralTablePanelDemo(Vector<Vector<Object>> data, String[] columnNames,
			int totalColumnCount) {

		tableModel = new GeneralTableModelDemo(data, columnNames, totalColumnCount,
				isEditing);
	...
	public GeneralTableModelDemo getTableModel() {
		return tableModel;
	}
	...
	public static void main(String[] args) {
		...
		JScrollPane scrollpane = new JScrollPane(new GeneralTablePanelDemo(data,
				columnNames, 3));
