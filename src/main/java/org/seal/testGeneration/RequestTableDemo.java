...
public class RequestTableDemo {

	public static GeneralTablePanelDemo getRequestTable(String request,
			boolean xmlView) {
		Vector<Vector<Object>> data = convertRequest(request);
		String[] columnNames = { "No", "Category", "Type", "Name", "Value" };
		return new GeneralTablePanelDemo(data, columnNames, 5);

		// this.xmlView
	}

	public static void setPreferredColumnWidths(GeneralTablePanelDemo gtp,
			double totalWidth) {
