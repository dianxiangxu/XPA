...
public abstract class BasicEvaluationCtx implements EvaluationCtx {
    ...
    protected EvaluationResult callHelper(URI type, URI id, String issuer, URI category) {
        // 1/23/15 Temporary fix for evaluation error:
    	// +++ (pdpConfig!=null&&)
    	// System.out.println(pdpConfig);
    	if (pdpConfig!=null && pdpConfig.getAttributeFinder() != null) {
        	//System.out.println(pdpConfig.getAttributeFinder().findAttribute(type, id, issuer, category, this));
