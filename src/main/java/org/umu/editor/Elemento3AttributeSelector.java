 ...
 * @version 1.3
 ****************************************************************/
public class Elemento3AttributeSelector extends ElementoXACML {

	public static final String TIPO_ATTRIBUTESELECTOR = "AttributeSelector";

	public Elemento3AttributeSelector(Map ht) {
	...
	public String getContextSelectorId() {
		return (String) super.getAtributos().get("ContextSelectorId");
	}
	
	public String getPath() {
		return (String) super.getAtributos().get("Path");
	}
