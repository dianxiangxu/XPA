...
/**
 * This class represents an XACML Action Match element.
 * 
 * @author Alberto Jim?nez L?zaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoActionMatch extends ElementoMatchAbstract {
	...
	public int getPosicion(ElementoXACML e) {
		if (e.getTipo().equals("AttributeValue"))
			return 1;
		else if (e.getTipo().equals("ActionAttributeDesignator"))
			return 2;
