...
/**
 * This class represents an abstract XACML Element being this class the root of
 * all elements of the XACML schema.
 * 
 * @author Alberto Jim?nez L?zaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public abstract class ElementoXACML implements Cloneable {

	private Map atributos;
	private String tipo;
	private boolean vacio;
	private String contenido;
	protected String[] Expression = { "Apply", "AttributeSelector", "AttributeValue", "Function", "VariableReference",
			"AttributeDesignator" };
	...
	public static String[] getAllDataTypes() {
		String[] allDataTypes = {
				...
				"http://www.w3.org/2001/XMLSchema#dayTimeDuration", // added
				"http://www.w3.org/2001/XMLSchema#yearMonthDuration", // added
				"http://www.w3.org/2001/XMLSchema#anyURI", "http://www.w3.org/2001/XMLSchema#hexBinary",
				"http://www.w3.org/2001/XMLSchema#base64Binary", "urn:oasis:names:tc:xacml:1.0:data-type:rfc822Name",
				"urn:oasis:names:tc:xacml:1.0:data-type:x500Name",
				"urn:oasis:names:tc:xacml:3.0:data-type:xpathExpression", // added
				"urn:oasis:names:tc:xacml:2.0:data-type:ipAddress", // added
				"urn:oasis:names:tc:xacml:2.0:data-type:dnsName" // added
		};
		return allDataTypes;
	}
	...
	public static String[] getAllPolicyCombiningAlgorithm() {
		String[] allPolicyCombiningAlgorithm = {
				...
				"urn:oasis:names:tc:xacml:3.0:policy-combining-algorithm:permit-overrides", // added
				"urn:oasis:names:tc:xacml:1.0:policy-combining-algorithm:deny-overrides",
				"urn:oasis:names:tc:xacml:3.0:policy-combining-algorithm:deny-overrides", // added
				"urn:oasis:names:tc:xacml:1.0:policy-combining-algorithm:first-applicable",
				"urn:oasis:names:tc:xacml:1.0:policy-combining-algorithm:only-one-applicable",
				"urn:oasis:names:tc:xacml:1.0:policy-combining-algorithm:ordered-deny-overrides",
				"urn:oasis:names:tc:xacml:3.0:policy-combining-algorithm:ordered-deny-overrides", // added
				"urn:oasis:names:tc:xacml:1.0:policy-combining-algorithm:ordered-permit-overrides",
				"urn:oasis:names:tc:xacml:3.0:policy-combining-algorithm:ordered-permit-overrides", // added
				"urn:oasis:names:tc:xacml:3.0:policy-combining-algorithm:deny-unless-permit", // added
				"urn:oasis:names:tc:xacml:3.0:policy-combining-algorithm:permit-unless-deny" // added
		};
	...
	public static String[] getAllRuleCombiningAlgorithm() {
		String[] allRuleCombiningAlgorithm = {
				...
				"urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:permit-overrides", // added
				"urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:deny-overrides",
				"urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:deny-overrides", // added
				"urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:first-applicable",
				"urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-deny-overrides",
				"urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:ordered-deny-overrides", // added
				"urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:ordered-permit-overrides",
				"urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:ordered-permit-overrides", // added
				"urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:deny-unless-permit", // added
				"urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:permit-unless-deny" // added
		};
		return allRuleCombiningAlgorithm;
	}

	public static String[] getAllPrefixesIdentifier() {
		String[] allPrefixesIdentifier = { "urn:oasis:names:tc:xacml:3.0", "urn:oasis:names:tc:xacml:2.0",
				"urn:oasis:names:tc:xacml:2.0:conformance-test", "urn:oasis:names:tc:xacml:2.0:context",
				"urn:oasis:names:tc:xacml:2.0:example", "urn:oasis:names:tc:xacml:1.0:function",
				"urn:oasis:names:tc:xacml:2.0:function", "urn:oasis:names:tc:xacml:2.0:policy",
				"urn:oasis:names:tc:xacml:1.0:subject", "urn:oasis:names:tc:xacml:1.0:resource",
				"urn:oasis:names:tc:xacml:1.0:action", "urn:oasis:names:tc:xacml:1.0:environment",
				"urn:oasis:names:tc:xacml:1.0:status" };
		return allPrefixesIdentifier;
	}

	// added for XACML 3.0
	public static String[] getAllDecision() {
		String[] allDecision = { "Permit", "Deny", "Indeterminate", "NotApplicable" };
		return allDecision;
	}

	public static String[] getAllCategory() {
		String[] allCategory = { "urn:oasis:names:tc:xacml:1.0:subject-category:access-subject",
	...
	public static String[] getAllAttributeId() {
		String[] allAttributeId = {
				...
				// JR
				"urn:oasis:names:tc:xacml:2.0:subject:role", "urn:xadl:domain:name",
				"urn:xadl:ArchTypes:ComponentType:id", "urn:xadl:ArchTypes:ConnectorType:id",
				"urn:xadl:archStructure:component:id", "urn:xadl:archStructure:connector:id",
				"urn:xadl:archStructure:link:point", "urn:xadl:archStructure:link:pointSource",
				"urn:xadl:archStructure:link:pointDestination", "urn:xadl:subject", "urn:xadl:principal",
				"urn:xadl:privilege", "urn:xadl:subject:src", "urn:xadl:principal:src", "urn:xadl:privilege:src",
				"urn:xadl:subject:dst", "urn:xadl:principal:dst", "urn:xadl:privilege:dst"
		// JREND
		};
	...
	public static String[] getAllSchemas() {
		String[] allSchemas = {
				"urn:oasis:names:tc:xacml:3.0:core:schema:wd-17", // added
				"urn:oasis:names:tc:xacml:2.0:policy:schema:os", "urn:oasis:names:tc:xacml:2.0:policy:schema:cd:04",
	...
	public static String[] getAllFunctions() {
		String[] allFunctions = {
				...
				"urn:oasis:names:tc:xacml:3.0:function:map", // added for
																// XACML3.0
	...
	public static String[] getPossibleAttributeValues() {
		String[] possibleAttributeValues = { "urn:oasis:names:tc:xacml:2.0:actions:hasPrivilegesOfRole",
				"urn:oasis:names:tc:xacml:2.0:actions:enableRole", "urn:xadl:action:AddBrick",
				"urn:xadl:action:RemoveBrick", "urn:xadl:action:BeginBrick", "urn:xadl:action:EndBrick",
				"urn:xadl:action:AddWeld", "urn:xadl:action:RemoveWeld", "urn:xadl:action:RouteMessage",
				"urn:xadl:action:rbac:addUser", "urn:xadl:action:rbac:addRole", "urn:xadl:action:rbac:assignUser",
				"urn:xadl:action:Trust", "RouteMessage", "SecureManagedSystem" };
	...
	public Object clone() {
		...
		obj = ElementoXACMLFactoryImpl.getInstance().obtenerElementoXACML(tipo, new Hashtable());
