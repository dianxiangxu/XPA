...
public class AttributeAssignmentPanel
  ...
  private void jbInit() throws Exception {
    ...
    jcmbDataType.setSelectedItem( ( (Elemento3AttributeAssignment) elemento).
                                 getDataType());
  ...
  public void keyReleased(KeyEvent e) {
    ...
    if(dtm!=null) dtm.nodeChanged(node);
  }
  public void itemStateChanged(ItemEvent e) {
    if (e.getSource() == jcmbDataType) {
      ( (Elemento3AttributeAssignment) elemento).setDataType( (String)
