...
public class ElementPanel extends JPanel {
	...
	public ElementPanel(DefaultMutableTreeNode n) {
		node = n;
		elemento = (ElementoXACML) node.getUserObject();
	}
...
class MiElementActionAdapter implements ActionListener {
...
class MiElementKeyAdapter extends KeyAdapter {
	private ElementPanel adaptee;
...
class MiElementItemAdapter implements ItemListener {
	private ElementPanel adaptee;
...
class MiTreeModelAdapter implements TreeModelListener {
	private ElementPanel adaptee;
...
class MiListSelectionAdapter implements ListSelectionListener {
	private ElementPanel adaptee;
