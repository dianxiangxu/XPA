 ...
 * @version 1.3
 ****************************************************************/
public class Elemento3Target extends ElementoXACML {

	public static final String TIPO_TARGET = "Target";
	private String[] allowedChild = { "AnyOf" };

	public Elemento3Target(Map ht) {
	...
	public int getPosicion(ElementoXACML e) {
		...
		if (array.contains(e.getTipo()))
			return array.indexOf(e.getTipo());
