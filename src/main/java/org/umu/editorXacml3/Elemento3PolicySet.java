 ...
 * @version 1.3
 ****************************************************************/
public class Elemento3PolicySet extends ElementoXACML {

	public static final String TIPO_POLICYSET = "PolicySet";

	public Elemento3PolicySet(Map ht) {
	...
	public String[] getAllowedChild() {
		String[] allowedChild = { "Description", "PolicyIssuer", "PolicySetDefaults", "Target", "PolicySet", "Policy",
				"PolicySetIdReference", "PolicyIdReference", "ObligationExpressions", "AdviceExpressions",
				"CombinerParameters", "PolicyCombinerParameters", "PolicySetCombinerParameters" };
		return allowedChild;
	}
	...
	public int getPosicion(ElementoXACML e) {
		...
		if (e.getTipo().equals("Target"))
			return 4;
		else if (e.getTipo().equals("PolicySet"))
			return 5;
		else if (e.getTipo().equals("Policy"))
			return 5;
		else if (e.getTipo().equals("PolicySetIdReference"))
			return 5;
		else if (e.getTipo().equals("PolicyIdReference"))
			return 5;
			...
			return 7;
		else if (e.getTipo().equals("PolicyCombinerParameters"))
			return 7;
		else if (e.getTipo().equals("PolicySetCombinerParameters"))
			return 7;
