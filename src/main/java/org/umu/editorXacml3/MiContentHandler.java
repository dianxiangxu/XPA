...
/**
 * This class implements the SAX ContentHandler Interface and permits manage the
 * xml content when sax processor is visiting the nodes
 * 
 * @author Alberto Jim?nez L?zaro,Pablo Galera Morcillo
 * @version 1.3
 */
public class MiContentHandler implements ContentHandler {
	...
	public void startDocument() throws SAXException {
		...
		elementoActual = new DefaultMutableTreeNode(new String(
				"Policy Document"));
	}

	public void endDocument() throws SAXException {
		// Add DefaultMutableTreeNode to DefaultTreeModel
	...
	public void startElement(String namespaceURI, String localName,
		...
		// Put all attributes to the hash table.
		...
		if (!resto) {
			...
			((ElementoXACML) elementoActual.getUserObject()).addContenido("<"
					+ qName + ">");
		}
	}
	...
	public void endElement(String namespaceURI, String localName, String qName)
		...
		if (!resto) {
			if (e == null) {
				...
				elementoActual = (DefaultMutableTreeNode) elementoActual
						.getParent();
				elementoActual.remove(aux);
				// JR Notify AnySubject/AnyResource/AnyAction is no longer in
				// XACML 2.0
				if (qName.equals("AnySubject") || qName.equals("AnyResource")
						|| qName.equals("AnyAction")) {
					warnings += "<" + qName
							+ "> has been removed from XACML 2.0\n";
				} else {
					// English
