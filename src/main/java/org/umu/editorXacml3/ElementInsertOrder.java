/*
calc * Copyright 2005, 2006 Alberto Jim?nez L?zaro
...
/**
 * This class permits insert different nodes on the Tree in the correct order
 *
 * @author Alberto Jim?nez L?zaro,Pablo Galera Morcillo
 * @version 1.3
 */

public class ElementInsertOrder {
  protected DefaultMutableTreeNode nodoPadre;
  protected DefaultMutableTreeNode nodoHijo;
  protected ElementoXACML elem;
  ElementoXACML array[];

  public ElementInsertOrder(DefaultMutableTreeNode nodoPadre,
