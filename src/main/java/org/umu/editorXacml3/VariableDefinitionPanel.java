...
/**
 * It's a panel for editing the VariableDefinition elements of the XACML 2.0
 * standard
 * 
 * Modifed for XACML 3.0 standard.
 * 
 * @author Albero Jimenez Lazaro & Pablo Galera Morcillo
 * @version 1.3
 */
public class VariableDefinitionPanel extends ElementPanel {
	...
	private void jbInit() throws Exception {
		...
		panel.setLocation(20, 85);
		panel.setPreferredSize(new Dimension(580, 160));
		this.add(panel);
		...
		while (subelementos.hasMoreElements()) {
			...
			if (panelActual != null) {
				...
				// } else if (elementoHijo instanceof
				...
				// } else if (elementoHijo instanceof
				// ElementoEnvironmentAttributeDesignator) {
				...
				panelActual.setLocation(20, 250);
