...
public class XACMLPanelFactoryImpl implements XACMLPanelFactory {
	...
	public ElementPanel obtenerPanel(DefaultMutableTreeNode n) {
		...
		} else if (n.getUserObject() instanceof Elemento3PolicySet) {
		...
		// added for XACML 3.0 by Z. Cheng
		...
		} else if (n.getUserObject() instanceof Elemento3AllOf) {
			ret = new Panel3AllOf(n);
		}
