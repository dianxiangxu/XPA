 ...
 *
 * Description:*//**
 * This is the panel for editing Apply Elements.
 * 
 * @author Alberto Jim?nez L?zaro & Pablo Galera Morcillo
 * 
 * @version 1.3
 ***************************************************************/
public class ApplyPanel extends ElementPanel implements Observer {
	...
	private void jbInit() throws Exception {
		...
		TitledBorder miborde1 = new TitledBorder(new EtchedBorder(), "List of Applies");
		...
		TitledBorder miborde2 = new TitledBorder(new EtchedBorder(), "List of Simple Expresions");
	...
	public void actualizar() {
		...
		while (subelementos.hasMoreElements()) {
			...
			if (aux.getUserObject() instanceof Elemento3Apply) {
				vec1.add(aux);
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (lista2 != null) {
			DefaultMutableTreeNode aux = (DefaultMutableTreeNode) lista2.getSelectedValue();
			...
			if (panelActual != null) {
				...
				TitledBorder miborde2 = new TitledBorder(new EtchedBorder(), elemHijo.getTipo());
